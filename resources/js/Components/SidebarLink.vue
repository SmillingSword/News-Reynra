  ...
  >
    ...
    <component 
      ...
      :class="[
        ...
        active ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-400'
      ]"
    />
    ...
    <svg 
      ...
      :class="[
        ...
        expanded ? 'rotate-90' : '',
        active ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500'
      ]"
      fill="currentColor" 
      viewBox="0 0 20 20"
    >
...
const iconComponent = computed(() => {
  ...
  return icons[props.icon] || icons.home
})
</script>
