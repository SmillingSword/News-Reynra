        ...
        <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center">
                            <Link :href="route('admin.dashboard')" class="flex items-center">
                                ...
                                <span class="ml-2 text-xl font-bold text-gray-800 dark:text-gray-200">News Reynra</span>
                            </Link>
                        </div>
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <NavLink :href="route('admin.comments.index')" :active="route().current('admin.comments.*')">
                                Comments
                            </NavLink>
            ...
            >
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <ResponsiveNavLink :href="route('admin.comments.index')" :active="route().current('admin.comments.*')">
                        Comments
                    </ResponsiveNavLink>
                    <ResponsiveNavLink :href="route('admin.media.index')" :active="route().current('admin.media.*')">
                        Media
                    </ResponsiveNavLink>
